        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm mb-6 leading-relaxed">
              Making healthcare accessible, intelligent, and simple for everyone through bleeding-edge artificial intelligence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li><a href="#" className="hover:text-blue-400 transition-colors">Blood Network</a></li>
              <li><a href="#" className="hover:text-blue-400 transition-colors">Smart Queue</a></li>
            </ul>
          </div>
